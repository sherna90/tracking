...
#include "Mask_CPU_hmc.hpp"

void Mask_CPU_Hamiltonian_MC::init(MatrixXd &_X, VectorXd &_Y, double _lambda, int _warmup_iterations, int _iterations, double _step_size, int _num_step, double _path_length){
	this->lambda=_lambda;
...
void Mask_CPU_Hamiltonian_MC::run(bool warmup_flag){
...
VectorXd Mask_CPU_Hamiltonian_MC::predict(MatrixXd &X_test, bool prob, int samples, bool erf, bool prob_label){
	/*
	Predict: 
...
void Mask_CPU_Hamiltonian_MC::setData(MatrixXd &_X,VectorXd &_Y){
